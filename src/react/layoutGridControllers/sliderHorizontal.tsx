...
const Option = (props) => (
  <StyledOption>
    ...
    <StyledRadioGroup>
      ...
      <StyledRadio htmlFor={props.type + "-9"}>
        <input
          type="radio"
          id={props.type + "-9"}
          name={props.type}
          value="9"
          onChange={props.onChange}
          checked={props.value == 9 ? true : false}
        />
        <span>9</span>
      </StyledRadio>
      <StyledRadio htmlFor={props.type + "-10"}>
        <input
          type="radio"
          id={props.type + "-10"}
          name={props.type}
          value="10"
          onChange={props.onChange}
          checked={props.value == 10 ? true : false}
        />
        <span>10</span>
      </StyledRadio>
      <StyledRadio htmlFor={props.type + "-11"}>
        <input
          type="radio"
          id={props.type + "-11"}
          name={props.type}
          value="11"
          onChange={props.onChange}
          checked={props.value == 11 ? true : false}
        />
        <span>11</span>
      </StyledRadio>
      <StyledRadio htmlFor={props.type + "-12"}>
        <input
          type="radio"
          id={props.type + "-12"}
          name={props.type}
          value="12"
          onChange={props.onChange}
          checked={props.value == 12 ? true : false}
        />
        <span>12</span>
      </StyledRadio>
    </StyledRadioGroup>
